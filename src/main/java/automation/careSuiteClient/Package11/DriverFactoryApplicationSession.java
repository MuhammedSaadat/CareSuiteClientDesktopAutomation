 ...
 *
 */
public class DriverFactoryApplicationSession
{
   ...
   private DriverFactoryApplicationSession()
   {
      //Do-nothing..Do not allow to initialize this class from outside
   }
   private static DriverFactoryApplicationSession instance = new DriverFactoryApplicationSession();

   public static DriverFactoryApplicationSession getInstance()
   {
      return instance;
   }
   ...
   
	{
	   ...
	   if(platform.trim().equalsIgnoreCase("Windows")) {
		   appCapabilities = new DesiredCapabilities();
			...
			driver.set(new WindowsDriver<WebElement>(new URL("http://"+Utils.loadProperty("portNumberWinAppDriver")+":"+Utils.loadProperty("iPAddressWinAppDriver")), appCapabilities));
			}
